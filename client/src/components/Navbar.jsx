...
const Navbar = () => {
  ...
  return (
    <div className=" fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5">
      ...
      <div
        className={` max-md:absolute max-md:top-0 max-md:left-0 max-md:font-medium max-md:text-lg z-50 flex flex-col md:flex-row items-center max-md:justify-center gap-8  md:px-8
         py-3 max-md:h-screen md:rounded-full backdrop-blur-0 bg-black/70 md:bg-white/10
      ...
      <div className="flex items-center gap-8">
        ...
        { !user ? ( <button onClick={openSignIn} className="px-4 py-1 sm:px-7 sm:py-2 bg-red-600 hover:bg-red-500 transition rounded-full font-medium cursor-pointer">
          Login
        </button>) : ( <UserButton>
